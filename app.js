...
const indexRouter = require('./views/routes')
const loginRouter = require('./views/routes/login')
const registerRouter = require('./views/routes/register')
const dashboardRouter = require('./views/routes/dashboard')
// view engine setup
